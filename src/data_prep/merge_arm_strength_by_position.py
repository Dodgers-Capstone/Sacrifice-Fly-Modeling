...
def merge_arm_strength_by_position(on_base_lf: pl.LazyFrame,
                                   arm_strength_data_lf: pl.LazyFrame,
                                   position: str) -> pl.LazyFrame:
    """
    ...
    col_names_to_suffix = [col for col in arm_strength_data_lf.collect_schema().names() if col not in col_names_ex_suffix]
