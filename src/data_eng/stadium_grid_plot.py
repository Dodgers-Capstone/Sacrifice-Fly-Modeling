# stadium_polar_plot_360_rays.py

import numpy as np
import matplotlib.pyplot as plt
from matplotlib.axes import Axes
# Import necessary pybaseball functions
...
def add_polar_grid(
    ...
    for angle_rad in angles_rad_math:
        ...
        ax.plot([center_x, x_end], [center_y, y_end], color=color, linestyle=linestyle,
                linewidth=linewidth, alpha=alpha, zorder=1)
...
if __name__ == "__main__":
    ...
    if not sub_data.empty:
        ...
        event_colors = {
            'single': '#008000', 'double': '#0000FF', 'triple': '#800080',
            'home_run': '#FF0000', 'field_out': '#808080', 'sac_fly': '#FFA500',
            'field_error': '#FFC0CB', 'grounded_into_double_play': '#A0522D',
            'force_out': '#D2691E',
        }
        ...
        stadium_ax.scatter(
             ...
             c=colors, s=40, alpha=0.7, zorder=5
         )
    ...
    stadium_ax.set_title(f'Jose Altuve Batted Balls ({start_dt} to {end_dt}, Home Team: {statcast_team_abbr})')
    try:
        plt.tight_layout()
    except UserWarning:
        pass
